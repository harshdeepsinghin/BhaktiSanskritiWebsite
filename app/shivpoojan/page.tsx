...
export default function Shivpoojan() {
  ...
  const features = [
    t('shivpoojan.feature1'),
    t('shivpoojan.feature2'),
    t('shivpoojan.feature3'),
    t('shivpoojan.feature4'),
    t('shivpoojan.feature5')
  ];
