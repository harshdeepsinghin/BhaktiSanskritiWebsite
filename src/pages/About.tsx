        ...
        <section className="bg-muted py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="prose prose-lg max-w-none text-muted-foreground mx-auto" style={{ fontFamily: 'Noto Sans Devanagari, serif', lineHeight: 2, fontSize: '1.15rem', wordBreak: 'break-word' }}>
                ...
                <p>ईश्वर ने भक्त की जिज्ञासा को पहचान लिया...<br />इस सावन महादेव प्रेरणा ने जन्म दिया एक शोध को —<br />और उस शोध ने आकार लिया <b>“भक्ति वृतिका”</b> — एक अनुपम, शोध आधारित और आत्मिक पूजन-पद्धति के रूप में।</p>
                <p>देवभूमि भारत संस्थान का जन्म केवल एक संगठन के रूप में नहीं हुआ,<br />बल्कि एक दिव्य अनुभूति और शोधपरक यात्रा के रूप में हुआ है।<br />यह संस्थान भारत की आध्यात्मिक परंपराओं, विधियों, और सांस्कृतिक ज्ञान को अनुभव, प्रयोग, और शुद्ध श्रद्धा के साथ फिर से जाग्रत करने का कार्य करता है।</p>
